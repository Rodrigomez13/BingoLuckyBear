...
// The original canvas renderer intentionally cropped some atlas symbols to fill tall cells.
// This patch keeps atlas art contained inside each tile so character faces and props do not get cut off.
